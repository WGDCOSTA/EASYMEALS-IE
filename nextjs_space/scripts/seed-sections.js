...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var sections, _i, sections_1, section, existing;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, prisma.productSection.findUnique({
                            where: { slug: section.slug }
                        })];
                case 2:
                    existing = _a.sent();
                    if (!!existing) return [3 /*break*/, 4];
                    return [4 /*yield*/, prisma.productSection.create({
                            data: section
                        })];
                case 3:
                    _a.sent();
                    ...
                    return [3 /*break*/, 5];
                case 4:
                    console.log("Section already exists: ".concat(section.name));
                    _a.label = 5;
                case 5:
                    _i++;
                    return [3 /*break*/, 1];
