        ...
        {nutritionDetails.map((item, index) => (
          ...
          >
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm font-medium" style={{ color: '#000000' }}>{item.label}</span>
            </div>
            <div className="flex items-baseline space-x-1">
              <span className="text-lg font-bold" style={{ color: '#000000' }}>{item.value || 0}</span>
              <span className="text-sm" style={{ color: '#1f2937' }}>{item.unit}</span>
            </div>
          </motion.div>
        ))}
      </div>
