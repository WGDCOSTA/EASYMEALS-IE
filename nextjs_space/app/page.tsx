  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <ParallaxSection className="relative bg-gradient-to-br from-green-50 via-white to-green-50 py-16" speed={0.3}>
        <AnimatedBackground variant="waves" color="#84cc16" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <FadeInSection direction="left" delay={100}>
              <div className="grid grid-cols-2 gap-4">
                <div className="relative aspect-[3/4] rounded-3xl overflow-hidden shadow-2xl transform rotate-2 hover:rotate-0 hover-lift transition-all duration-500">
                  <Image
                ...
                <div className="relative aspect-[3/4] rounded-3xl overflow-hidden shadow-2xl transform -rotate-2 hover:rotate-0 hover-lift transition-all duration-500 mt-8">
                  <Image
                    src="https://cdn.abacus.ai/images/89c41a16-b55b-4ced-b876-30b5b3a7e3db.png"
      ...
      <ParallaxSection className="relative py-20 bg-gradient-to-br from-green-50 via-green-100/50 to-green-50" speed={0.4}>
        <AnimatedBackground variant="particles" color="#84cc16" />
        ...
        <div className="container mx-auto max-w-7xl px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <FadeInSection direction="up" delay={100}>
              <div className="bg-white rounded-3xl shadow-xl overflow-hidden hover-lift group">
          ...
          <FadeInSection direction="up" delay={400} className="text-center">
            <Button asChild size="lg" className="bg-easymeals-green hover:bg-easymeals-green/90 hover:scale-105 text-white rounded-full font-semibold text-lg px-10 shadow-xl hover:shadow-2xl transition-all duration-300 pulse-cta">
              <Link href="/meals">
                Get Started Now
              </Link>
            </Button>
      ...
      <section className="py-20 bg-gradient-to-br from-orange-50 via-white to-green-50 relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-orange-100 via-white to-green-100 opacity-50 animate-gradient"></div>
        ...
        <div className="container mx-auto max-w-7xl px-4 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
            {/* One-Time Purchase */}
            <FadeInSection direction="left" delay={100}>
              <div className="relative bg-white rounded-3xl shadow-xl p-8 hover:shadow-2xl transition-all duration-500 border-2 border-transparent hover:border-easymeals-orange group hover-lift">
                <div className="absolute top-4 right-4 bg-easymeals-orange text-white px-4 py-2 rounded-full text-sm font-bold animate-pulse">
                  Most Flexible
                </div>
                <ShoppingBag className="w-16 h-16 text-easymeals-orange mb-6 group-hover:animate-float" />
                ...
                <Button asChild className="w-full bg-easymeals-orange hover:bg-easymeals-orange/90 hover:scale-105 text-white font-bold py-6 rounded-full text-lg transition-all duration-300">
            ...
            <FadeInSection direction="right" delay={100}>
              <div className="relative bg-gradient-to-br from-green-500 to-green-600 rounded-3xl shadow-xl p-8 hover:shadow-2xl transition-all duration-500 text-white group hover-lift animate-gradient">
                <div className="absolute top-4 right-4 bg-yellow-400 text-gray-900 px-4 py-2 rounded-full text-sm font-bold flex items-center gap-1 animate-pulse">
                  <TrendingUp className="w-4 h-4" />
                  Save 15%
                </div>
                <Star className="w-16 h-16 text-yellow-300 mb-6 fill-yellow-300 group-hover:animate-float" />
                ...
                <Button asChild className="w-full bg-white text-easymeals-green hover:bg-gray-100 hover:scale-105 font-bold py-6 rounded-full text-lg shadow-lg transition-all duration-300">
      ...
      <ParallaxSection className="py-20 bg-gradient-to-br from-green-50 via-white to-green-50" speed={0.3}>
        <div className="container mx-auto max-w-7xl px-4">
          <FadeInSection direction="up" className="text-center mb-12">
            <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Review 1 */}
            <FadeInSection direction="up" delay={100}>
              <div className="bg-white rounded-2xl shadow-lg p-8 hover-lift group">
                <div className="flex items-center mb-4">
                  <div className="w-14 h-14 rounded-full bg-gradient-to-br from-orange-400 to-orange-500 flex items-center justify-center text-white text-xl font-bold mr-4 group-hover:animate-float">
                    OL
                  </div>
                  <div>
            ...
            <FadeInSection direction="up" delay={200}>
              <div className="bg-white rounded-2xl shadow-lg p-8 hover-lift group">
                <div className="flex items-center mb-4">
                  <div className="w-14 h-14 rounded-full bg-gradient-to-br from-green-400 to-green-500 flex items-center justify-center text-white text-xl font-bold mr-4 group-hover:animate-float">
                    AM
                  </div>
                  <div>
            ...
            <FadeInSection direction="up" delay={300}>
              <div className="bg-white rounded-2xl shadow-lg p-8 hover-lift group">
                <div className="flex items-center mb-4">
                  <div className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-400 to-blue-500 flex items-center justify-center text-white text-xl font-bold mr-4 group-hover:animate-float">
                    SM
                  </div>
                  <div>
      ...
      <ParallaxSection className="py-20 bg-gradient-to-br from-orange-400 via-orange-500 to-easymeals-orange text-white relative" speed={0.5}>
        <AnimatedBackground variant="waves" color="#fb923c" />
        
        {/* Decorative elements */}
        <div className="absolute top-10 right-10 w-32 h-32 bg-white opacity-10 rounded-full blur-2xl animate-float"></div>
        <div className="absolute bottom-10 left-10 w-40 h-40 bg-yellow-300 opacity-10 rounded-full blur-3xl animate-float" style={{animationDelay: '1s'}}></div>
        <div className="absolute top-1/2 left-1/4 w-24 h-24 bg-white opacity-5 rounded-full blur-xl animate-float" style={{animationDelay: '2s'}}></div>
        
        <div className="container mx-auto max-w-4xl px-4 text-center relative z-10">
          <FadeInSection direction="up">
            <div className="glass-effect rounded-3xl p-12 shadow-2xl border-2 border-white/20 hover-lift">
              <h2 className="text-4xl lg:text-5xl font-bold mb-6 animate-fade-in-up">
                Try EasyMeals This Week
              </h2>
              <p className="text-xl mb-10 opacity-95 max-w-2xl mx-auto animate-fade-in-up" style={{animationDelay: '200ms'}}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up" style={{animationDelay: '400ms'}}>
                <Button asChild size="lg" className="bg-white text-orange-600 hover:bg-gray-100 hover:scale-110 font-bold rounded-full shadow-lg hover:shadow-2xl transition-all duration-300 text-lg px-8">
                  <Link href="/meals">Browse Meals</Link>
                </Button>
                <Button asChild size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-orange-500 hover:scale-110 font-bold rounded-full bg-transparent transition-all duration-300 text-lg px-8">
                  <Link href="/subscriptions">Start Subscription</Link>
                </Button>
              </div>
            </div>
